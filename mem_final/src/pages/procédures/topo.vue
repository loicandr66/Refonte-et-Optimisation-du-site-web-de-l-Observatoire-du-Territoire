    ...
    <div class="topo">
        ...
        <div class="detail">
            ...
            <div class="part" :class="{'deroule':deroule}" @click="deroule=!deroule" id="nav">
                ...
                <div class="liens">
                    <ul>
                        <li><RouterLink to="/Procédures/Aménagement">Aménagement du Territoire</RouterLink></li>
            ...
            <div class="part" id="contenu">
                <div class="intro">
                    <h4>Topo</h4>
                    <p>Standard des services fournis au sein de la Direction des Etudes et des Travaux Topographiques ainsi que ses démembrements</p>
                </div>
                <div class="listes">
                    <liste
...
export default {
    ...
    async function loadingData () {
        try {
          const res = await fetch("http://localhost:3000/api/procedures/filter/type_procedure/Topo");
